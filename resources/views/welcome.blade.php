  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center text-center mt-auto">
        <h2 data-aos="fade-up" data-aos-delay="100" class="">THE RajaEvents <span>Videos & Photography</span></h2>
        <p data-aos="fade-up" data-aos-delay="200">Nawada,Bihar</p>
    ...
    <!-- Venue Section -->
    <section id="eventgallery" class="venue section">

      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Event Gallery<br></h2>
    ...
    <!-- Hotels Section -->
    <section id="services" class="hotels section">
    ...
    <!-- Buy Tickets Section -->
    <section id="date-book" class="buy-tickets section light-background">

      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Event Date Book<br></h2>
        <p>Necessitatibus eius consequatur ex aliquid fuga eum quidem sint consectetur velit</p>
      </div><!-- End Section Title -->
    ...
    <!-- Speakers Section -->
    <section id="team_members" class="speakers section">
